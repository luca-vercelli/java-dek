...
public class JavaIfElseTest {
	...
	public void testJdk170IfElse() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 148: 148 */",
				"if ((i == 1 && i == 2 && i == 3) || (i == 4 && i == 5 && i == 6) || (i == 7 && i == 8 && i == 9))")));
		assertTrue(source.matches(PatternMaker.make("/* 160: 160 */",
				"if ((i == 1 || i == 2 || i == 3) && (i == 4 || i == 5 || i == 6) && (i == 7 || i == 8 || i == 9))")));

		assertTrue(source.matches(PatternMaker.make("/* 172: 172 */",
				"if ((i == 1 || (i == 5 && i == 6 && i == 7) || i == 8 || (i == 9 && i == 10 && i == 11)) && (i == 4 || i % 200 > 50) && (i > 3 || i > 4))")));
		assertTrue(source.matches(PatternMaker.make("/* 184: 184 */",
				"if ((i == 1 && (i == 5 || i == 6 || i == 7) && i == 8 && (i == 9 || i == 10 || i == 11)) || (i == 4 && i % 200 > 50) || (i > 3 && i > 4))")));
