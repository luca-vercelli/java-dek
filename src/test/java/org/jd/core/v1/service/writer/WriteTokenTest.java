...
public class WriteTokenTest {
    ...
    public void writeClassDeclaration() throws Exception {
        ...
        tokens.add(CLASS);
        tokens.add(TextToken.SPACE);
        tokens.add(new DeclarationToken(DeclarationToken.TYPE, "org/jd/core/v1/service/test/WriteTokenTest",
                "WriteTokenTest", null));
        tokens.add(TextToken.SPACE);
        ...
        tokens.add(VOID);
        tokens.add(TextToken.SPACE);
        tokens.add(new DeclarationToken(DeclarationToken.METHOD, "org/jd/core/v1/service/test/WriteTokenTest", "main",
                "([Ljava/lang/String;)V"));
        tokens.add(TextToken.LEFTROUNDBRACKET);
        tokens.add(new ReferenceToken(ReferenceToken.TYPE, "java/lang/String", "String", null,
                "org/jd/core/v1/service/test/WriteTokenTest"));
        ...
        tokens.add(new ReferenceToken(ReferenceToken.METHOD, "org/jd/core/v1/service/test/WriteTokenTest", "call",
                "(IILjava/util/Enumeration;I)V", "org/jd/core/v1/service/test/WriteTokenTest"));
        ...
        tokens.add(NEW);
        tokens.add(TextToken.SPACE);
        tokens.add(new ReferenceToken(ReferenceToken.TYPE, "java/util/Enumeration", "Enumeration", null,
                "org/jd/core/v1/service/test/WriteTokenTest"));
        tokens.add(new TextToken("() "));
        tokens.add(StartBlockToken.START_BLOCK);
        tokens.add(NewLineToken.NEWLINE_1);
        ...
        tokens.add(BOOLEAN);
        tokens.add(TextToken.SPACE);
        tokens.add(new DeclarationToken(DeclarationToken.METHOD, "org/jd/core/v1/service/test/WriteTokenTest$1",
                "hasMoreElements", "()Z"));
        tokens.add(StartBlockToken.START_PARAMETERS_BLOCK);
        ...
        tokens.add(PUBLIC);
        tokens.add(TextToken.SPACE);
        tokens.add(new ReferenceToken(ReferenceToken.TYPE, "java/lang/Object", "Object", null,
                "org/jd/core/v1/service/test/WriteTokenTest"));
        tokens.add(TextToken.SPACE);
        tokens.add(new DeclarationToken(DeclarationToken.METHOD, "org/jd/core/v1/service/test/WriteTokenTest$1",
        ...
        tokens.add(new ReferenceToken(ReferenceToken.TYPE, "java/lang/System", "System", null,
                "org/jd/core/v1/service/test/WriteTokenTest"));
        tokens.add(TextToken.DOT);
        tokens.add(new ReferenceToken(ReferenceToken.FIELD, "java/lang/System", "out", "java/io/PrintStream",
                "org/jd/core/v1/service/test/WriteTokenTest"));
        tokens.add(TextToken.DOT);
        tokens.add(new ReferenceToken(ReferenceToken.METHOD, "java/io/PrintStream", "println", "(I)V",
                "org/jd/core/v1/service/test/WriteTokenTest"));
        tokens.add(TextToken.LEFTROUNDBRACKET);
        tokens.add(new TextToken("i"));
    ...
    public void testComments() throws Exception {
        ...
        Assert.assertTrue(
                source.indexOf("<MARKER type='JAVADOC'>/** Javadoc comment */</MARKER type='JAVADOC'>") != -1);
    }
}
