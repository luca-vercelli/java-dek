...
public class MergeMembersUtilTest {
    ...
    public void testMergeFieldsAndMethods() throws Exception {
        ...
        assertEquals(fields.size() + methods.size(), result.size());
        assertEquals(10, ((ClassFileMemberDeclaration) result.get(3)).getFirstLineNumber());
        assertEquals(11, ((ClassFileMemberDeclaration) result.get(4)).getFirstLineNumber());
        assertEquals(20, ((ClassFileMemberDeclaration) result.get(9)).getFirstLineNumber());
        assertEquals(21, ((ClassFileMemberDeclaration) result.get(10)).getFirstLineNumber());
        assertEquals(30, ((ClassFileMemberDeclaration) result.get(11)).getFirstLineNumber());
    }
    ...
    public void testMergeFieldsMethodsAndInnerTypes_0() throws Exception {
        ...
        assertEquals(fields.size() + methods.size() + innerTypes.size(), result.size());
        assertEquals(10, ((ClassFileMemberDeclaration) result.get(3)).getFirstLineNumber());
        assertEquals(11, ((ClassFileMemberDeclaration) result.get(4)).getFirstLineNumber());
        assertEquals(20, ((ClassFileMemberDeclaration) result.get(9)).getFirstLineNumber());
        assertEquals(21, ((ClassFileMemberDeclaration) result.get(10)).getFirstLineNumber());
        assertEquals(30, ((ClassFileMemberDeclaration) result.get(11)).getFirstLineNumber());
        assertEquals(0, ((ClassFileMemberDeclaration) result.get(12)).getFirstLineNumber());
        assertEquals(0, ((ClassFileMemberDeclaration) result.get(20)).getFirstLineNumber());
    }
    ...
    public void testMergeFieldsMethodsAndInnerTypes_25() throws Exception {
        ...
        assertEquals(20, ((ClassFileMemberDeclaration) result.get(9)).getFirstLineNumber());
        assertEquals(21, ((ClassFileMemberDeclaration) result.get(10)).getFirstLineNumber());
        assertEquals(25, ((ClassFileMemberDeclaration) result.get(11)).getFirstLineNumber());
        assertEquals(30, ((ClassFileMemberDeclaration) result.get(12)).getFirstLineNumber());
    }

    @Test
    public void testMergeFields() throws Exception {
        ClassFileFieldDeclaration a = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT,
                new FieldDeclarator("a"));
        ClassFileFieldDeclaration b = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT,
                new FieldDeclarator("b"));
        ClassFileFieldDeclaration c = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT,
    ...
    public void testMergeAscendantSortedFields2() throws Exception {
        ...
        ClassFileFieldDeclaration c = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT,
                new FieldDeclarator("c"));
        ClassFileFieldDeclaration d = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT, new FieldDeclarator("d"),
                2);
        ClassFileFieldDeclaration e = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT, new FieldDeclarator("e"),
                3);
        ClassFileFieldDeclaration f = new ClassFileFieldDeclaration(0, PrimitiveType.TYPE_INT,
    ...
    protected DefaultList<ClassFileMemberDeclaration> newInnerTypes(int lineNumber) {
        ...
        ClassFile classFile = new ClassFile(JavaVersion.JAVA5, 0, 0, "A", "java/lang/Object", null, null, null, null);
    ...
    protected static ClassFileMethodDeclaration newMethodDeclaration(ClassFile classFile, Method method, String name,
            int firstLineNumber) {
        return new ClassFileMethodDeclaration(null, classFile, method, name, PrimitiveType.TYPE_VOID, null,
                Collections.emptyMap(), Collections.emptyMap(), firstLineNumber);
    }
}
