...
public class JavaLoopTest {
    ...
    public void testJdk170While() throws Exception {
        ...
        assertTrue(source.indexOf(
                "while ((i == 1 || (i == 5 && i == 6 && i == 7) || i == 8 || (i == 9 && i == 10 && i == 11)) && (i == 4 || i % 200 > 50) && (i > 3 || i > 4))") != -1);
        assertTrue(source.indexOf(
                "while ((i == 1 && (i == 5 || i == 6 || i == 7) && i == 8 && (i == 9 || i == 10 || i == 11)) || (i == 4 && i % 200 > 50) || (i > 3 && i > 4))") != -1);
    ...
    public void testJdk170For() throws Exception {
        ...
        assertTrue(
                source.matches(PatternMaker.make(": 112 */", "for (int i = 0, j = i, size = 10; i < size; j += ++i)")));
        ...
        assertTrue(
                source.matches(PatternMaker.make(": 215 */", "for (int[] i = { 0 }, j = i, k = j; i.length < 10;);")));
        ...
        assertTrue(source
                .matches(PatternMaker.make(": 245 */", "for (int i = 0, j = i, size = 10; i < size; j += ++i);")));
        ...
        assertTrue(source.matches(PatternMaker.make(": 411 */",
                "Iterator<Class<?>> iterator = Arrays.<Class<?>>asList(getClass().getInterfaces()).iterator()")));
    ...
    public void testJdk170NoDebugInfoFor() throws Exception {
        ...
        // FIXME
        // Recompile decompiled source code and check errors
        // assertTrue(CompilerUtil.compile("1.7", new
        // JavaSourceFileObject(internalClassName, source)));
    }
