...
public class JavaTernaryOperatorTest {
    ...
    public void testJdk118TernaryOperator() throws Exception {
        ...
        assertTrue(source.matches(PatternMaker.make(": 137 */",
                "if (s1 == s2 && ((s1 == null) ? (s2 == null) : s1.equals(s2)) && s1 == s2)")));
        assertTrue(source.matches(PatternMaker.make(": 148 */",
                "if (s1 == s2 || ((s1 == null) ? (s2 == null) : s1.equals(s2)) || s1 == s2)")));
        assertTrue(source
                .matches(PatternMaker.make(": 157 */", "return Short.toString((short)((this == null) ? 1 : 2));")));
