...
public class JavaBasicTest {
	...
	public void testJdk170Basic() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make(
				"Class class5 = doSomething(class6 = String.class, args1 = args2 = new String[], class4 = class5;")));
		...
		assertTrue(source
				.matches(PatternMaker.make(": 128 */", "int int78 = getInt78(new Object[] { this }, (short)5);")));
		assertTrue(source
				.matches(PatternMaker.make(": 130 */", "i = (int)(Basic.long12 + long12) + this.int78 + int78;")));
		...
		assertTrue(source.matches(
				PatternMaker.make("/* 188: 188 */", "protected static final Integer INTEGER_255 = new Integer(255);")));
	...
	public void testJdk170NoDebugInfoBasic() throws Exception {
		...
		assertTrue(source.indexOf(
				"Class clazz5 = doSomething(clazz6 = String.class, arrayOfString1 = arrayOfString2 = new String[]") != -1);
	...
	public void testJdk118Basic() throws Exception {
		...
		// Check decompiled source code
		assertTrue(source.matches(
				PatternMaker.make(":  43 */", "Class class3 = String.class, class2 = class3, class1 = class2;")));
		assertTrue(source.matches(PatternMaker.make("String stringNull = null;")));
		assertTrue(source.indexOf("public static native int read();") != -1);
		assertTrue(source
				.matches(PatternMaker.make(": 128 */", "int int78 = getInt78(new Object[] { this }, (short)5);")));
	...
	public void testJdk901Basic() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make(":  18 */", "protected short short56 = 56;")));
		assertTrue(source.matches(PatternMaker.make(":  19 */", "protected int int78 = 78;")));
		assertTrue(source.matches(PatternMaker.make(":  43 */",
				"Class<String> class3 = String.class, class2 = class3, class1 = class2;")));
		assertTrue(source.matches(PatternMaker.make("String stringNull = null;")));
		assertTrue(source.indexOf("public static native int read();") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 173: 173 */", "return str + str;")));
		assertTrue(source.matches(PatternMaker.make("/* 176: 176 */", "return str;")));
	...
	public void testAnnotationUtils() throws Exception {
		...
		Map<String, Object> configuration = Collections.singletonMap("realignLineNumbers", Boolean.TRUE);
		String source = decompiler.decompile(internalClassName, configuration);
