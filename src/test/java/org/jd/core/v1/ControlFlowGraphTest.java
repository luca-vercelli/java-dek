...
public class ControlFlowGraphTest {
	...
	public void testJdk170BasicDoSomethingWithString() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Basic",
	...
	public void testJdk170If() throws Exception {
		checkIfReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "if_")));
	}

	@Test
	public void testJdk170IfIf() throws Exception {
		ControlFlowGraph cfg = checkIfReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifIf")));
	...
	public void testJdk170MethodCallInIfCondition() throws Exception {
		checkIfElseReduction(checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/IfElse", "methodCallInIfCondition")));
	}

	@Test
	public void testJdk170IlElse() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElse")));
	...
	public void testJdk170IlElseIfElse() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElseIfElse")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfORCondition() throws Exception {
		ControlFlowGraph cfg = checkIfReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifORCondition")));
		BasicBlock ifBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfANDCondition() throws Exception {
		ControlFlowGraph cfg = checkIfReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifANDCondition")));
		BasicBlock ifBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfElseORCondition() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElseORCondition")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfElseANDCondition() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElseANDCondition")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfElse6ANDAnd2ORCondition() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElse6ANDAnd2ORCondition")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfElse6ORAnd2ANDCondition() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElse6ORAnd2ANDCondition")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170IfElseORAndANDConditions() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElseORAndANDConditions")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testIfElseANDAndORConditions() throws Exception {
		ControlFlowGraph cfg = checkIfElseReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/IfElse", "ifElseANDAndORConditions")));
		BasicBlock ifElseBB = cfg.getStart().getNext().getNext();
	...
	public void testJdk170OuterClass() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/OuterClass", "<init>"));
	}
	...
	public void testJdk170TernaryOperatorsInTernaryOperator() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/TernaryOperator",
				"ternaryOperatorsInTernaryOperator"));
	}

	@Test
	public void testJdk118TernaryOperatorsInReturn() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"), "org/jd/core/test/TernaryOperator",
				"ternaryOperatorsInReturn"));
	}
	...
	public void testJdk118TernaryOperatorInIf1() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"),
				"org/jd/core/test/TernaryOperator", "ternaryOperatorInIf1"));
	...
	public void testJdk118TernaryOperatorInIfElse3() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"),
				"org/jd/core/test/TernaryOperator", "ternaryOperatorInIfElse3"));
	...
	public void testJdk118TernaryOperatorInIfElseANDCondition() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"), "org/jd/core/test/TernaryOperator",
				"ternaryOperatorInIfElseANDCondition"));
	}
	...
	public void testJdk118TernaryOperatorInIfElseORCondition() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"),
				"org/jd/core/test/TernaryOperator", "ternaryOperatorInIfElseORCondition"));
	...
	public void testJdk170TernaryOperatorInIfElseORCondition() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TernaryOperator", "ternaryOperatorInIfElseORCondition"));
	...
	public void testJdk170SimpleSwitch() throws Exception {
		checkSwitchReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "simpleSwitch")));
	}

	@Test
	public void testJdk170SwitchFirstBreakMissing() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "switchFirstBreakMissing")));
	...
	public void testJdk170SwitchSecondBreakMissing() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "switchSecondBreakMissing")));
		SwitchCase sc0 = switchBB.getSwitchCases().get(0);
	...
	public void testJdk170SwitchDefault() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "switchDefault")));
	...
	public void testJdk170LookupSwitchDefault() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "lookupSwitchDefault")));
		SwitchCase scDefault = switchBB.getSwitchCases().get(0);
	...
	public void testJdk170SwitchOneExitInFirstCase() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "switchOneExitInFirstCase")));
		SwitchCase scDefault = switchBB.getSwitchCases().get(0);
	...
	public void testJdk170SwitchOneExitInSecondCase() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "switchOneExitInSecondCase")));
		SwitchCase scDefault = switchBB.getSwitchCases().get(0);
	...
	public void testJdk170SwitchOneExitInLastCase() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(searchMethod(
				getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "switchOneExitInLastCase")));
		SwitchCase sc0 = switchBB.getSwitchCases().get(0);
	...
	public void testJdk170ComplexSwitch() throws Exception {
		BasicBlock switchBB = checkSwitchReduction(checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch", "complexSwitch")));
		SwitchCase scDefault = switchBB.getSwitchCases().get(0);
	...
	public void testJdk170SwitchOnLastPosition() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch",
				"switchOnLastPosition"));
	}

	@Test
	public void testJdk170SwitchFirstIfBreakMissing() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/Switch",
				"switchFirstIfBreakMissing"));
	}

	@Test
	public void testJdk170SwitchString() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/AdvancedSwitch",
				"switchString"));
	}
	...
	public void testJdk170SimpleWhile() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "simpleWhile"));
	}

	@Test
	public void testJdk170WhileIfContinue() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileIfContinue"));
	}

	@Test
	public void testJdk170WhileIfBreak() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileIfBreak"));
	}

	@Test
	public void testJdk170WhileWhile() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileWhile"));
	}

	@Test
	public void testJdk170WhileThrow() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileThrow"));
	}

	@Test
	public void testJdk170WhileTrue() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileTrue"));
	}

	@Test
	public void testJdk170WhileTryFinally() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileTryFinally"));
	}

	@Test
	public void testJdk170TryWhileFinally() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "tryWhileFinally"));
	}

	@Test
	public void testJdk170InfiniteWhileTryFinally() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While",
				"infiniteWhileTryFinally"));
	}

	@Test
	public void testJdk170TryInfiniteWhileFinally() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While",
				"tryInfiniteWhileFinally"));
	}

	@Test
	public void testJdk170WhileTrueIf() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "whileTrueIf"));
	...
	public void testJdk170TwoWiles() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/While", "twoWiles"));
	...
	public void testJdk170DoWhileWhile() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/DoWhile", "doWhileWhile"));
	}

	@Test
	public void testJdk170DoWhileTestPreInc() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/DoWhile",
				"doWhileTestPreInc"));
	}
	...
	public void testJdk150ForTryReturn() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.5.0.zip"), "org/jd/core/test/For", "forTryReturn"));
	...
	public void testJdk170IfForIfReturn() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/For", "ifForIfReturn"));
	}

	@Test
	public void testJdk170ForIfContinue() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/For", "forIfContinue"));
	}

	@Test
	public void testJdk170ForIfIfContinue() throws Exception {
		checkCFGReduction(
				searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/For", "forIfIfContinue"));
	}

	@Test
	public void testJdk170ForMultipleVariables2() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/For",
				"forMultipleVariables2"));
	}
	...
	public void testJdk170DoWhileContinue() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/BreakContinue", "doWhileContinue"));
	...
	public void testJdk170TripleDoWhile1() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/BreakContinue",
				"tripleDoWhile1"));
	}
	...
	public void testJdk170TripleDoWhile2() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/BreakContinue", "tripleDoWhile2"));
	...
	public void testJdk170DoWhileWhileTryBreak() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/BreakContinue", "doWhileWhileTryBreak"));
	...
	public void testJdk170MethodTryCatch() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatch"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testEclipseJavaCompiler370MethodTrySwitchFinally() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTrySwitchFinally"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testEclipseJavaCompiler3130MethodTrySwitchFinally() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.13.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTrySwitchFinally"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryCatchCatch() throws Exception {
		BasicBlock tryBB = checkTryCatchFinallyReduction(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryCatchCatch")));
	...
	public void testEclipseJavaCompiler321MethodTryCatchCatch() throws Exception {
		BasicBlock tryBB = checkTryCatchFinallyReduction(
				checkCFGReduction(searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.2.1.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryCatchCatch")));
	...
	public void testEclipseJavaCompiler321MethodTryCatchFinally1() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.2.1.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinally1"));
	}
	...
	public void testJdk170MethodTryCatchCatchExitInTry() throws Exception {
		BasicBlock tryBB = checkTryCatchFinallyReduction(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryCatchCatchOneExitInTry")));
	...
	public void testJdk170MethodTryCatchCatchExitInFirstCatch() throws Exception {
		BasicBlock tryBB = checkTryCatchFinallyReduction(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryCatchCatchOneExitInFirstCatch")));
	...
	public void testJdk170MethodTryCatchCatchExitInLastCatch() throws Exception {
		BasicBlock tryBB = checkTryCatchFinallyReduction(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryCatchCatchOneExitInLastCatch")));
	...
	public void testJdk131MethodTryCatchFinallyInTryCatchFinally() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.3.1.zip"), "org/jd/core/test/TryCatchFinally",
				"methodTryCatchFinallyInTryCatchFinally"));
	}

	@Test
	public void testJdk170MethodTryCatchFinallyInTryCatchFinally() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinallyInTryCatchFinally"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170Try1Resource() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/TryWithResources",
				"try1Resource"));
	}
	...
	public void testJdk170MethodTryFinallyReturn() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryFinallyReturn"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryCatch3() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatch3"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryFinally1() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryFinally1"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryFinally3() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryFinally3"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryFinally4() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryFinally4"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryCatchFinally2() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"), "org/jd/core/test/TryCatchFinally",
				"methodTryCatchFinally2"));
	}
	...
	public void testEclipseJavaCompiler370MethodTryCatchFinally2() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryCatchFinally2"));
	...
	public void testJdk170MethodTryCatchFinally4() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinally4"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testEclipseJavaCompiler321MethodTryCatchFinally5() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.2.1.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinally5"));
	}

	@Test
	public void testEclipseJavaCompiler370MethodTryCatchFinally5() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinally5"));
	}

	@Test
	public void testEclipseJavaCompiler3130MethodTryCatchFinally5() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.13.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinally5"));
	}
	...
	public void testEclipseJavaCompiler370MethodTryTryFinallyFinallyTryFinallyReturn() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryTryFinallyFinallyTryFinallyReturn"));
	}
	...
	public void testJdk170MethodTryTryFinallyFinallyTryFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK5(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}

	@Test
	public void testEclipseJavaCompiler321ComplexMethodTryCatchCatchFinally() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.2.1.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testHarmonyJdkR533500ComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK118(
				checkCFGReduction(searchMethod(getResource("zip/data-java-harmony-jdk-r533500.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testIbm_J9_VmComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK5(
				checkCFGReduction(searchMethod(getResource("zip/data-java-ibm-j9_vm.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testJdk118ComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK118(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testJdk131ComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK118(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.3.1.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}

	@Test
	public void testJdk142ComplexMethodTryCatchCatchFinally() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.4.2.zip"),
				"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk150ComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK5(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.5.0.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testJdk160ComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK5(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.6.0.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testJikes1_22_1WindowsComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK118(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jikes-1.22-1.windows.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testJRockit90_150_06ComplexMethodTryCatchCatchFinally() throws Exception {
		checkComplexMethodTryCatchCatchFinally_JDK5(
				checkCFGReduction(searchMethod(getResource("zip/data-java-jrockit-90_150_06.zip"),
						"org/jd/core/test/TryCatchFinally", "complexMethodTryCatchCatchFinally")));
	}
	...
	public void testJdk118MethodIfIfTryCatch() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"),
				"org/jd/core/test/TryCatchFinally", "methodIfIfTryCatch"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk170MethodTryCatchFinallyReturn() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.7.0.zip"),
				"org/jd/core/test/TryCatchFinally", "methodTryCatchFinallyReturn"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testEclipseJavaCompiler370MethodTryTryFinallyFinallyTryFinally() throws Exception {
		ControlFlowGraph cfg = checkCFGReduction(
				searchMethod(getResource("zip/data-java-eclipse-java-compiler-3.7.0.zip"),
						"org/jd/core/test/TryCatchFinally", "methodTryTryFinallyFinallyTryFinally"));
		BasicBlock startBB = cfg.getStart();
	...
	public void testJdk118MethodTryTryFinallyFinallyTryFinally() throws Exception {
		checkCFGReduction(searchMethod(getResource("zip/data-java-jdk-1.1.8.zip"), "org/jd/core/test/TryCatchFinally",
				"methodTryTryFinallyFinallyTryFinally"));
	}
	...
	protected static void checkFinalCFG(ControlFlowGraph cfg) {
		...
		for (int i = 0, len = list.size(); i < len; i++) {
			...
			assertTrue("#" + basicBlock.getIndex() + " is a TRY_DECLARATION -> reduction failed",
					basicBlock.getType() != TYPE_TRY_DECLARATION);
			assertTrue("#" + basicBlock.getIndex() + " is a SWITCH_DECLARATION -> reduction failed",
					basicBlock.getType() != TYPE_SWITCH_DECLARATION);
			assertTrue("#" + basicBlock.getIndex() + " is a CONDITIONAL -> reduction failed",
					basicBlock.getType() != TYPE_CONDITIONAL_BRANCH);
			assertTrue("#" + basicBlock.getIndex() + " is a GOTO -> reduction failed",
					basicBlock.getType() != TYPE_GOTO);

			if (!basicBlock.matchType(GROUP_CONDITION)) {
				for (BasicBlock predecessor : basicBlock.getPredecessors()) {
					assertTrue("#" + predecessor.getIndex() + " is a predecessor of #" + basicBlock.getIndex()
							+ " but #" + predecessor.getIndex() + " does not refer it",
							predecessor.contains(basicBlock));
				}
			}

			if (basicBlock.matchType(TYPE_IF | TYPE_IF_ELSE)) {
				assertTrue("#" + basicBlock.getIndex() + " is a IF or a IF_ELSE with a 'then' branch jumping to itself",
						basicBlock.getSub1() != basicBlock);
			}

			if (basicBlock.getType() == TYPE_IF_ELSE) {
				assertTrue("#" + basicBlock.getIndex() + " is a IF_ELSE with a 'else' branch jumping to itself",
						basicBlock.getSub2() != basicBlock);
			}
			...
			if (basicBlock.matchType(TYPE_TRY | TYPE_TRY_JSR)) {
				...
				for (ExceptionHandler exceptionHandler : basicBlock.getExceptionHandlers()) {
					...
					if (name == null) {
						assertFalse("#" + basicBlock.getIndex() + " contains multiple finally handlers",
								containsFinally);
						containsFinally = true;
					} else {
						assertFalse("#" + basicBlock.getIndex() + " contains multiple handlers for " + name,
								exceptionNames.contains(name));
						exceptionNames.add(name);
					}

					assertTrue("#" + basicBlock.getIndex() + " have an invalid exception handler",
							!exceptionHandler.getBasicBlock().matchType(GROUP_CONDITION));
				...
				for (ExceptionHandler exceptionHandler : basicBlock.getExceptionHandlers()) {
					...
					if (maxOffset != offset) {
						...
						while ((bb != next)
								&& next.matchType(GROUP_SINGLE_SUCCESSOR | TYPE_RETURN | TYPE_RETURN_VALUE | TYPE_THROW)
						...
						assertTrue(
								"#" + basicBlock.getIndex() + " is a TRY or TRY_WITH_JST -> #"
										+ exceptionHandler.getBasicBlock().getIndex() + " handler reduction failed",
								offset < maxOffset);
					}
				}
			}
			...
			if (basicBlock.getType() == TYPE_SWITCH) {
				for (SwitchCase switchCase : basicBlock.getSwitchCases()) {
					assertTrue("#" + basicBlock.getIndex() + " have an invalid switch case",
							!switchCase.getBasicBlock().matchType(GROUP_CONDITION));
				}
			}

			if (!basicBlock.matchType(GROUP_CONDITION)) {
				assertTrue("#" + basicBlock.getIndex() + " have an invalid next basic block",
						(basicBlock.getNext() == null) || !basicBlock.getNext().matchType(GROUP_CONDITION));
				assertTrue("#" + basicBlock.getIndex() + " have an invalid branch basic block",
						(basicBlock.getBranch() == null) || !basicBlock.getBranch().matchType(GROUP_CONDITION));
				assertTrue("#" + basicBlock.getIndex() + " have an invalid sub1 basic block",
						(basicBlock.getSub1() == null) || !basicBlock.getSub1().matchType(GROUP_CONDITION));
				assertTrue("#" + basicBlock.getIndex() + " have an invalid sub2 basic block",
						(basicBlock.getSub2() == null) || !basicBlock.getSub2().matchType(GROUP_CONDITION));
			}
		}
		...
		assertFalse("DELETED basic block detected -> reduction failed",
				(result != null) && (result.getType() == TYPE_DELETED));
	...
	protected static BasicBlock checkBasicBlock(BitSet visited, BasicBlock basicBlock, SilentWatchDog watchdog) {
		if ((basicBlock == null) || basicBlock.matchType(
				TYPE_END | TYPE_SWITCH_BREAK | TYPE_LOOP_START | TYPE_LOOP_CONTINUE | TYPE_LOOP_END | TYPE_RETURN)) {
			return null;
		} else {
			BasicBlock result;
	...
	protected static BasicBlock checkBasicBlock(BitSet visited, BasicBlock parent, BasicBlock child,
			SilentWatchDog watchdog) {
