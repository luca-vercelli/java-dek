...
public class JavaFragmentToTokenTest {
	...
	public void testIfReturn_0() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*   4:   0 */", "i = 1;")));
	}
	...
	public void testIfReturn_1_3() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 1: 1 */", "if (args == null)")));
		assertTrue(source.matches(PatternMaker.make("/* 2: 0 */", "return;")));
		assertTrue(source.matches(PatternMaker.make("/* 3: 3 */", "int i = 1;")));
	}
	...
	public void testIfReturn_1_4() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 1: 1 */", "if (args == null)")));
		assertTrue(source.matches(PatternMaker.make("/* 2: 0 */", "return;")));
		assertTrue(source.matches(PatternMaker.make("/* 4: 4 */", "int i = 1;")));
	}
	...
	public void testIfAssignation_1_2_3() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 1: 1 */", "if (args == null)")));
		assertTrue(source.matches(PatternMaker.make("/* 2: 2 */", "i = 0;")));
		assertTrue(source.matches(PatternMaker.make("/* 3: 3 */", "i = 1;")));
	...
	public void testIfAssignation_1_3_5() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 1: 1 */", "if (args == null)")));
		assertTrue(source.matches(PatternMaker.make("/* 2: 0 */", "{")));
		assertTrue(source.matches(PatternMaker.make("/* 3: 3 */", "i = 0;")));
		assertTrue(source.matches(PatternMaker.make("/* 5: 5 */", "i = 1;")));
	}
	...
	public void testClassAndFieldDeclarationWithoutImports_0() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*   4:   0 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_0() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*   7:   0 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_1() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 1 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.indexOf("/* 2: 0 */  -->") != -1);
	}
	...
	public void testClassAndFieldDeclaration_2() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 2: 2 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_3() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 2: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 3: 3 */", "protected int a")));
		assertTrue(source.indexOf("/* 4: 0 */ } -->") != -1);
	}
	...
	public void testClassAndFieldDeclaration_4() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 3: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 4: 4 */", "protected int a")));
		assertTrue(source.indexOf("/* 5: 0 */ } -->") != -1);
	}
	...
	public void testClassAndFieldDeclaration_5() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 4: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 5: 5 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_6() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 3: 0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/* 5: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 6: 6 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_7() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 3: 0 */", "import java.util.ArrayList")));
		assertTrue(source.matches(PatternMaker.make("/* 4: 0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/* 6: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 7: 7 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_8() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 4: 0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/* 6: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 8: 8 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_9() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 4: 0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/* 6: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 9: 9 */", "protected int a")));
	}
	...
	public void testClassAndFieldDeclaration_10() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*  4:  0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/*  6:  0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 10: 10 */", "protected int a")));
	}
	...
	public void testClassAndMethodDeclaration_3() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 2: 0 */", "public TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 3: 3 */", "super(i);")));
	}
	...
	public void testClassAndMethodDeclaration_4() throws Exception {
		...
		assertTrue(source.indexOf("/* 1: 0 */ package org.jd.core.v1.service.writer;") != -1);
		assertTrue(source.matches(PatternMaker.make("/* 2: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 3: 0 */", "public TokenWriterTest", "(int i)")));
	}
	...
	public void testClassAndMethodDeclaration_8() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 4: 0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/* 6: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 7: 0 */", "public TokenWriterTest", "(int i)")));
	}
	...
	public void testClassAndMethodDeclaration_9() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 4: 0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/* 6: 0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 8: 0 */", "public TokenWriterTest", "(int i)")));
	}
	...
	public void testClassAndMethodDeclaration_10() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*  1:  0 */", "package org.jd.core.v1.service.writer;")));
		assertTrue(source.matches(PatternMaker.make("/*  3:  0 */", "import java.util.ArrayList")));
		assertTrue(source.matches(PatternMaker.make("/*  4:  0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/*  6:  0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/*  7:  0 */", "extends Test")));
		assertTrue(source.matches(PatternMaker.make("/*  8:  0 */", "implements Serializable")));
		assertTrue(source.matches(PatternMaker.make("/*  9:  0 */", "public TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 10: 10 */", "super")));
	}
	...
	public void testClassAndMethodDeclaration_11() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*  7:  0 */", "extends Test")));
		assertTrue(source.matches(PatternMaker.make("/*  8:  0 */", "implements Serializable")));
		assertTrue(source.matches(PatternMaker.make("/* 10:  0 */", "public TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 11: 11 */", "super")));
	}
	...
	public void testClassAndMethodDeclaration_12() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*  3:  0 */", "import java.util.ArrayList")));
		assertTrue(source.matches(PatternMaker.make("/*  4:  0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/*  7:  0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/*  8:  0 */", "extends Test")));
		assertTrue(source.matches(PatternMaker.make("/*  9:  0 */", "implements Serializable")));
		assertTrue(source.matches(PatternMaker.make("/* 11:  0 */", "public TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 12: 12 */", "super")));
	}
	...
	public void testClassAndMethodDeclaration_14() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*  3:  0 */", "import java.util.ArrayList")));
		assertTrue(source.matches(PatternMaker.make("/*  4:  0 */", "import org.junit.Assert")));
		assertTrue(source.matches(PatternMaker.make("/*  9:  0 */", "public class TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 10:  0 */", "extends Test")));
		assertTrue(source.matches(PatternMaker.make("/* 11:  0 */", "implements Serializable")));
		assertTrue(source.matches(PatternMaker.make("/* 13:  0 */", "public TokenWriterTest")));
		assertTrue(source.matches(PatternMaker.make("/* 14: 14 */", "super")));
	}
	...
	public void testLayout() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 22: 22 */", "System", "println", "(i);")));
	}
	...
	public void testLayoutWithoutLineNumber() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/*  15:   0 */", "public Object", "nextElement")));
	}
	...
	public void testLayoutWithStretchedfFragments_2() throws Exception {
		...
		assertTrue(source.indexOf("/* 44: 44 */") != -1);
	}
	...
	public void testLayoutWithStretchedfFragments_3() throws Exception {
		...
		assertTrue(source.indexOf("/* 66: 66 */") != -1);
	}
	...
	public void testMoveDown() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 7: 0 */", "public static void main")));
	}
	...
	public void testLinkedBlocks_16() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 16: 16 */", "i = 4;")));
	}
	...
	public void testLinkedBlocks_22() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make("/* 22: 22 */", "i = 4;")));
	}

	/**
	 * Generate : [ 1: 0 ] <-- 0,1,2147483647:4 [ 2: lineNumber1] -->if (args ==
	 * null)<-- 0,1,2:5 [ 3: 0 ] -->return;<-- 0,0,2:5 --><-- 0,1,2147483647:4 [ 4:
	 * lineNumber2] -->int i = 1;<-- 0,1,2147483647:4 [ 5: 0 ] -->
	 *
	 * @param lineNumber1
	 * @param lineNumber2
	 * @return A message
	...
	public Message createMessageToTestIfReturn(int lineNumber1, int lineNumber2) throws Exception {
		...
		List<Token> tokens = Arrays.asList(IF, TextToken.SPACE, TextToken.LEFTROUNDBRACKET,
				new LineNumberToken(lineNumber1), new TextToken("args == "), NULL, TextToken.RIGHTROUNDBRACKET);
		...
		// return;\n
		fragments.add(new TokensFragment(RETURN, TextToken.SEMICOLON));
		// End of if (args == null)
		JavaFragmentFactory.addEndSingleStatementBlock(fragments, start);

		JavaFragmentFactory.addSpacerBetweenStatements(fragments);

		tokens = Arrays.asList(INT, new LineNumberToken(lineNumber2), new TextToken(" i = 1;"));
		...
		message.setMaxLineNumber(Integer.valueOf(lineNumber2));
	...
	/**
	 * Generate : [ 1: 0 ] <-- 0,1,2147483647:4 [ 2: lineNumber1] -->if (args ==
	 * null)<-- 0,1,2:5 [ 3: lineNumber2] -->i = 0;<-- 0,0,2:5 --><--
	 * 0,1,2147483647:4 [ 4: lineNumber3] -->i = 1;<-- 0,1,2147483647:4 [ 5: 0 ] -->
	 *
	 * @param lineNumber1
	 * @param lineNumber2
	 * @param lineNumber3
	...
	public Message createMessageToTestIfAssignation(int lineNumber1, int lineNumber2, int lineNumber3)
		...
		StartSingleStatementBlockFragment start = JavaFragmentFactory.addStartSingleStatementBlock(fragments);
		// i = 0;\n
		tokens = Arrays.asList(new LineNumberToken(lineNumber2), new TextToken("i = 0;"));
		...
		tokens = Arrays.asList(new LineNumberToken(lineNumber3), new TextToken("i = 1;"));
		...
		Message message = new Message();
		message.setFragments(fragments);
		message.setMaxLineNumber(Integer.valueOf(lineNumber3));
	...
	public Message createMessageToTestClassDeclaration(int lineNumber) throws Exception {
		...
		// public class TokenWriterTest extends Test implements Serializable,
		// Comparable<Test>, Cloneable {\n
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_TYPE_BLOCK);
		fragments.add(new TokensFragment(
				PUBLIC, TextToken.SPACE, CLASS, TextToken.SPACE, new DeclarationToken(DeclarationToken.TYPE,
						"org/jd/core/v1/service/test/TokenWriterTest", "TokenWriterTest", null),
				StartBlockToken.START_DECLARATION_OR_STATEMENT_BLOCK));

		JavaFragmentFactory.addSpacerBeforeExtends(fragments);

		fragments.add(new TokensFragment(EXTENDS, TextToken.SPACE,
		...
		fragments.add(new TokensFragment(IMPLEMENTS, TextToken.SPACE,
				...
				new ReferenceToken(ReferenceToken.TYPE, "org/jd/core/v1/service/test/Test", "Test", null, null),
				TextToken.RIGHTANGLEBRACKET, TextToken.COMMA_SPACE,
		...
		List<Token> tokens = Arrays.asList(PROTECTED, TextToken.SPACE, INT, TextToken.SPACE,
				new DeclarationToken(DeclarationToken.FIELD, "org/jd/core/v1/service/test/TokenWriterTest", "a", "I"),
				new TextToken(" = "), new LineNumberToken(lineNumber), new NumericConstantToken("0"),
				TextToken.SEMICOLON);
		...
		Message message = new Message();
		message.setFragments(fragments);
		message.setMaxLineNumber(Integer.valueOf(lineNumber));
	 ...
	 *
	 * --><-- 0,M,0 import java.util.ArrayList; import org.junit.*; --><-- 0,1,1
	 * --><-- 0,++,5 -->public class TokenWriterTest <-- 0,1,4 -->extends Test <--
	 * 0,1,3 -->implements Serializable, Comparable<Test>, Cloneable <-- { 0,2,2 -->
	...
	public Message createMessageToTestClassAndMethodDeclaration(int lineNumber) throws Exception {
		...
		fragments.add(new TokensFragment(PUBLIC, TextToken.SPACE,
				new DeclarationToken(DeclarationToken.CONSTRUCTOR, "org/jd/core/v1/service/test/TokenWriterTest",
						"TokenWriterTest", "(I)V"),
				TextToken.LEFTROUNDBRACKET, INT, TextToken.SPACE, new TextToken("i"), TextToken.RIGHTROUNDBRACKET));

		StartBodyFragment startConstructor = JavaFragmentFactory.addStartMethodBody(fragments);

		fragments.add(new LineNumberTokensFragment(new LineNumberToken(lineNumber), SUPER, TextToken.LEFTROUNDBRACKET,
				new TextToken("i"), TextToken.RIGHTROUNDBRACKET, TextToken.SEMICOLON));
	 ...
	 *
	 * --><-- 0,M,0 import java.util.ArrayList; import org.junit.*; --><-- 0,1,1
	 * --><-- 0,++,5 -->public class TokenWriterTest<-- { 0,2,2 --> public static
	 * void main(String[] args) {<-- { 0,2,5 --> if (args == null);<-- { 0,2,8
	 * --><-- 0,++,9 --> return;<-- 0,++,8 --><-- } 0,2,8 --><-- 0,++,8 --> int i =
	 * call(\n "aaaa",\n b,\n new Enumeration()<-- { 0,2,2 --> public boolean
	 * hasMoreElements()<-- { 0,2,5 --> return false; <-- } 0,2,7 --><-- 0,1,4
	 * --><-- 0,++,7 --> public Object nextElement()<-- { 0,2,5 --> return null; <--
	 * } 0,2,7 --><-- } 0,2,2 -->,<-- 0,++,8 --> c);<-- 0,++,8 -->
	...
	public Message createSimpleMessage(int factor) {
		...
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_TYPE_BLOCK);
		fragments.add(new TokensFragment(PUBLIC, TextToken.SPACE, CLASS, TextToken.SPACE, new DeclarationToken(
				DeclarationToken.TYPE, "org/jd/core/v1/service/test/TokenWriterTest", "TokenWriterTest", null)));

		StartBodyFragment startMainClass = JavaFragmentFactory.addStartTypeBody(fragments);

		// public static void main(String[] args) {\n
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_METHOD_BLOCK);
		fragments.add(new TokensFragment(PUBLIC, TextToken.SPACE, STATIC, TextToken.SPACE, VOID, TextToken.SPACE,
				new DeclarationToken(DeclarationToken.METHOD, "org/jd/core/v1/service/test/TokenWriterTest", "main",
						"([Ljava/lang/String;)V"),
				TextToken.LEFTROUNDBRACKET, new ReferenceToken(ReferenceToken.TYPE, "java/lang/String", "String", null,
		...
		// if (args == null)\n
		List<Token> tokens = Arrays.asList(IF, TextToken.SPACE, TextToken.LEFTROUNDBRACKET,
				new LineNumberToken(8 * factor), new TextToken("args == "), NULL, TextToken.RIGHTROUNDBRACKET);
		...
		// b,\n
		// new Enumeration() {\n
		tokens = Arrays.asList(INT, new LineNumberToken(10 * factor), new TextToken(" i = "),
				new ReferenceToken(ReferenceToken.METHOD, "org/jd/core/v1/service/test/TokenWriterTest", "call",
						"(IILjava/util/Enumeration;I)V", "org/jd/core/v1/service/test/TokenWriterTest"),
				StartBlockToken.START_PARAMETERS_BLOCK, new LineNumberToken(11 * factor),
				new StringConstantToken("aaaa", "org/jd/core/v1/service/test/TokenWriterTest"), TextToken.COMMA,
				TextToken.SPACE, new LineNumberToken(12 * factor), new TextToken("b,"), TextToken.SPACE,
				new LineNumberToken(13 * factor), NEW, TextToken.SPACE,
				new ReferenceToken(ReferenceToken.TYPE, "java/util/Enumeration", "java.util.Enumeration", null,
						"org/jd/core/v1/service/test/TokenWriterTest"),
		...
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_METHOD_BLOCK);
		fragments.add(new TokensFragment(
				PUBLIC, TextToken.SPACE, BOOLEAN, TextToken.SPACE, new DeclarationToken(DeclarationToken.METHOD,
						"org/jd/core/v1/service/test/TokenWriterTest$1", "hasMoreElements", "()Z"),
				TextToken.LEFTRIGHTROUNDBRACKETS));

		StartBodyFragment startHasMoreElementsMethodBody = JavaFragmentFactory.addStartMethodBody(fragments);

		// return false;\n
		tokens = Arrays.asList(RETURN, TextToken.SPACE, new LineNumberToken(15 * factor), FALSE, TextToken.SEMICOLON);
		...
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_METHOD_BLOCK);
		fragments.add(new TokensFragment(PUBLIC, TextToken.SPACE,
				new ReferenceToken(ReferenceToken.TYPE, "java/lang/Object", "Object", null,
						"org/jd/core/v1/service/test/TokenWriterTest"),
				TextToken.SPACE, new DeclarationToken(DeclarationToken.METHOD,
						"org/jd/core/v1/service/test/TokenWriterTest$1", "nextElement", "()Ljava/lang/Object;"),
				TextToken.LEFTRIGHTROUNDBRACKETS));

		StartBodyFragment startNextElementMethodBody = JavaFragmentFactory.addStartMethodBody(fragments);

		// return null;\n
		tokens = Arrays.asList(RETURN, TextToken.SPACE, new LineNumberToken(18 * factor), NULL, TextToken.SEMICOLON);
		...
		tokens = Arrays.asList(new LineNumberToken(21 * factor), new TextToken("c"), EndBlockToken.END_PARAMETERS_BLOCK,
				TextToken.SEMICOLON, NewLineToken.NEWLINE_1, new LineNumberToken(22 * factor),
				new ReferenceToken(ReferenceToken.TYPE, "java/lang/System", "System", null,
						"org/jd/core/v1/service/test/TokenWriterTest"),
				TextToken.DOT,
				new ReferenceToken(ReferenceToken.FIELD, "java/lang/System", "out", "java/io/PrintStream",
						"org/jd/core/v1/service/test/TokenWriterTest"),
				TextToken.DOT,
				new ReferenceToken(ReferenceToken.METHOD, "java/io/PrintStream", "println", "(I)V",
						"org/jd/core/v1/service/test/TokenWriterTest"),
		...
		message.setFragments(fragments);
		if (factor != 0)
			message.setMaxLineNumber(Integer.valueOf(22 * factor));
	...
	public Message createMessageToTestMoveDown() {
		...
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_FIELD_BLOCK);
		fragments
				.add(new LineNumberTokensFragment(PUBLIC, TextToken.SPACE, STATIC, TextToken.SPACE, INT,
						TextToken.SPACE, new DeclarationToken(DeclarationToken.FIELD,
								"org/jd/core/v1/service/test/TokenWriterTest", "TIMESTAMP", "I"),
						new TextToken(" = "), new LineNumberToken(4), new ReferenceToken(ReferenceToken.TYPE,
								"java/lang/System", "System", null, "org/jd/core/v1/service/test/TokenWriterTest"),
						TextToken.DOT,
						new ReferenceToken(ReferenceToken.METHOD, "java/lang/System", "currentTimeMillis", "()J",
								"org/jd/core/v1/service/test/TokenWriterTest"),
		...
		// protected int a;
		fragments.add(StartMovableJavaBlockFragment.START_MOVABLE_FIELD_BLOCK);
		fragments.add(new TokensFragment(PROTECTED, TextToken.SPACE, INT, TextToken.SPACE,
				new DeclarationToken(DeclarationToken.FIELD, "org/jd/core/v1/service/test/TokenWriterTest", "a", "I"),
				TextToken.SEMICOLON));
		fragments.add(EndMovableJavaBlockFragment.END_MOVABLE_BLOCK);
		...
		StartBodyFragment startMainMethodBody = JavaFragmentFactory.addStartMethodBody(fragments);
		// StartBodyFragment startMainMethodBody =
		// JavaFragmentFactory.addStartMethodBody(fragments);

		// System.out.println(TIMESTAMP);
		fragments.add(new LineNumberTokensFragment(new LineNumberToken(8),
				new ReferenceToken(ReferenceToken.TYPE, "java/lang/System", "System", null,
						"org/jd/core/v1/service/test/TokenWriterTest"),
				TextToken.DOT,
				new ReferenceToken(ReferenceToken.FIELD, "java/lang/System", "out", "java/io/PrintStream",
				...
				new ReferenceToken(ReferenceToken.METHOD, "java/io/PrintStream", "println", "(I)V",
						"org/jd/core/v1/service/test/TokenWriterTest"),
				TextToken.LEFTROUNDBRACKET, new TextToken("TIMESTAMP"), TextToken.RIGHTROUNDBRACKET,
				TextToken.SEMICOLON));
		...
		Message message = new Message();
		message.setFragments(fragments);
		message.setMaxLineNumber(Integer.valueOf(8));
	...
	/**
	 * Generate: [ 1: 0 ] package org.jd.core.v1.service.writer;<-- 0,2,2:9 [ 2: 0 ]
	 * [ 3: 0 ] -->public class
	 * TokenWriterTest<META-DECLARATION type='+TYPE' internalName=
	 * 'org/jd/core/v1/service/test/TokenWriterTest' descriptor='null'/><-- 0,1,2:2
	 * [ 4: 0 ] { [ 5: 0 ] -->public static void
	 * main<META-DECLARATION type='+METHOD' internalName=
	 * 'org/jd/core/v1/service/test/TokenWriterTest' descriptor=
	 * '([Ljava/lang/String;)V'/>(String<META-REFERENCE type='+TYPE' internalName=
	 * 'java/lang/String' descriptor='null' ownerInternalName=
	 * 'org/jd/core/v1/service/test/TokenWriterTest'/>[] args)<-- 0,0,2:11 { [ 6:
	 * lineNumber1] -->int i = 0;<-- 0,1,2147483647:4 [ 7: 0 ] [ 8: 0 ] -->try<--
	 * 0,1,2:5 { [ 9: lineNumber2] --><-- 0,0,2147483647:19 -->i = 1;<--
	 * 0,0,2147483647:18 --><-- 0,1,2:5 [ 10: 0 ] } -->catch
	 * (RuntimeException<META-REFERENCE type='+TYPE' internalName=
	 * 'java/lang/RuntimeException' descriptor='null' ownerInternalName=
	 * 'org/jd/core/v1/service/test/TokenWriterTest'/> e)<-- 0,1,2:5 { [ 11:
	 * lineNumber3] --><-- 0,0,2147483647:19 -->i = 2;<-- 0,0,2147483647:18 --><--
	 * 0,1,2:5 [ 12: 0 ] } -->finally<-- 0,1,2:5 { [ 13: lineNumber4] --><--
	 * 0,0,2147483647:19 -->i = 3;<-- 0,0,2147483647:18 --><-- 0,1,2:5 [ 14: 0 ] }
	 * --><-- 0,1,2147483647:4 [ 15: 0 ] [ 16: lineNumber5] -->i = 4;<-- 0,1,1:3 [
	 * 17: 0 ] } --><-- 0,1,1:1 [ 18: 0 ] } -->
	 *
	 * @param lineNumber1
	 * @param lineNumber2
	...
	public Message createMessageToTestLinkedBlocks(int lineNumber1, int lineNumber2, int lineNumber3, int lineNumber4,
		...
		// int i = 0;
		fragments.add(new LineNumberTokensFragment(new LineNumberToken(lineNumber1), INT, new TextToken(" i = 0;")));
		...
		// i = 1;
		fragments.add(new LineNumberTokensFragment(new LineNumberToken(lineNumber2), new TextToken("i = 1;")));

		JavaFragmentFactory.addEndStatementsBlock(fragments, group);

		// catch (RuntimeException e)
		fragments.add(new TokensFragment(
				CATCH, new TextToken(" ("), new ReferenceToken(ReferenceToken.TYPE, "java/lang/RuntimeException",
						"RuntimeException", null, "org/jd/core/v1/service/test/TokenWriterTest"),
				new TextToken(" e)")));

		JavaFragmentFactory.addStartStatementsBlock(fragments, group);

		// i = 2;
		fragments.add(new LineNumberTokensFragment(new LineNumberToken(lineNumber3), new TextToken("i = 2;")));

		JavaFragmentFactory.addEndStatementsBlock(fragments, group);

		// finally
		fragments.add(new TokensFragment(FINALLY));

		JavaFragmentFactory.addStartStatementsBlock(fragments, group);

		// i = 3;
		fragments.add(new LineNumberTokensFragment(new LineNumberToken(lineNumber4), new TextToken("i = 3;")));
		...
		// i = 4;
		fragments.add(new LineNumberTokensFragment(new LineNumberToken(lineNumber5), new TextToken("i = 4;")));
