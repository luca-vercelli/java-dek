...
public class JavaArrayTest {
	...
	public void testInitializedArrayInTernaryOperator() throws Exception {
		...
		// Check decompiled source code
		assertTrue(source
				.matches(PatternMaker.make(" 80 */", "return (i == 0) ? new Class<?>[] { Object.class } : null;")));
		assertTrue(source.matches(PatternMaker.make(" 84 */",
				"return (i == 0) ? new Class<?>[] { Object.class, String.class, Number.class } : null;")));
		assertTrue(source.matches(PatternMaker.make(" 88 */",
				"return (i == 0) ? new Class[][] { { Object.class }, { String.class, Number.class } } : null;")));
		assertTrue(source
				.matches(PatternMaker.make(" 92 */", "return (i == 0) ? null : new Class<?>[] { Object.class };")));
		assertTrue(source.matches(PatternMaker.make(" 96 */",
				"return (i == 0) ? null : new Class<?>[] { Object.class, String.class, Number.class };")));
		assertTrue(source.matches(PatternMaker.make(" 100 */",
				"return (i == 0) ? null : new Class[][] { { Object.class }, { String.class, Number.class} };")));
		assertTrue(source.matches(PatternMaker.make(" 104 */",
				"return (i == 0) ? new Class<?>[] { Object.class } : new Class<?>[] { String.class, Number.class };")));
