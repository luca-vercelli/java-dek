...
public class JavaLambdaTest {
	...
	public void testJdk180Lambda() throws Exception {
		...
		assertTrue(source.matches(PatternMaker.make(": 20 */",
		...
		assertTrue(source.matches(PatternMaker.make(": 32 */",
		...
		assertTrue(source
				.matches(PatternMaker.make(": 58 */", "Consumer<String> staticMethodReference = String::valueOf;")));
		assertTrue(source.matches(PatternMaker.make(": 59 */",
				"BiFunction<String, String, Integer> methodReference = String::compareTo;")));
		assertTrue(source
				.matches(PatternMaker.make(": 60 */", "Supplier<String> instanceMethodReference = s::toString;")));
		assertTrue(
				source.matches(PatternMaker.make(": 61 */", "Supplier<String> constructorReference = String::new;")));
		assertTrue(source
				.matches(PatternMaker.make(": 65 */", "MethodType mtToString = MethodType.methodType(String.class);")));
		assertTrue(source.matches(PatternMaker.make(": 66 */",
				"MethodType mtSetter = MethodType.methodType(void.class, Object.class);")));
		assertTrue(source.matches(PatternMaker.make(": 67 */",
