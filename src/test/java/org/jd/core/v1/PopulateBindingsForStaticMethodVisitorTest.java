...
public class PopulateBindingsForStaticMethodVisitorTest extends TestCase {
	...
	public void test() throws Exception {
		...
		BaseTypeArgument returnedType = new ObjectType("java/util/List", "java.util.List", "List",
				wildcardExtendsString);
		BaseTypeArgument parameterTypes = new TypeArguments(
				Arrays.asList(new ObjectType("java/util/Set", "java.util.Set", "Set", TYPE_INTEGER), TYPE_INT));

		// <I, O> List<O> method(Set<I> set, char)
		BaseTypeArgument genericReturnedType = new ObjectType("java/util/List", "java.util.List", "List",
				new GenericType("O"));
		BaseTypeArgument genericParameterTypes = new TypeArguments(
				Arrays.asList(new ObjectType("java/util/Set", "java.util.Set", "Set", new GenericType("I")), TYPE_INT));

		// Create bindings
		PopulateBindingsWithTypeArgumentVisitor visitor = new PopulateBindingsWithTypeArgumentVisitor(
				new TypeMaker(new ClassPathLoader()));
