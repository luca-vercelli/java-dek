...
public class ClassFileSuperConstructorInvocationExpression extends SuperConstructorInvocationExpression {
    ...
    public ClassFileSuperConstructorInvocationExpression(int lineNumber, ObjectType type, String descriptor,
            BaseType parameterTypes, BaseExpression parameters) {
