...
/**
 * Collect all LocalVariableReferenceExpression's found in
 * localVariableReferenceExpressions
 * 
 * ...and... ?!?
 */
public class DeclaredSyntheticLocalVariableVisitor extends AbstractJavaSyntaxVisitor {
    ...
    public void visit(LocalVariableReferenceExpression expression) {
        ...
        if (localVariableReferenceExpressions.containsAll(localVariable.getReferences())) {
            // works because the only implementation of LocalVariableReferenceExpression is
            // ClassFileLocalVariableReferenceExpression and this implements
