...
public class Section {
    ...
    public Section(DefaultList<FlexibleFragment> flexibleFragments, FixedFragment fixedFragment,
            Section previousSection) {
        this.flexibleFragments = flexibleFragments;
        this.fixedFragment = fixedFragment;
        this.previousSection = previousSection;

        assert (flexibleFragments != null) && (flexibleFragments.size() > 0)
                : "Section must contain flexible fragments";
        ...
        if (fixedFragment != null) {
            ...
            if (force || (lastLineCount != currentLineCount)) {
                ...
                if (targetLineCount != currentLineCount) {
                    ...
                    DefaultList<FlexibleFragment> constrainedFlexibleFragments = new DefaultList<>(
                            flexibleFragments.size());
    ...
    public boolean releaseConstraints(VisitorsHolder holder) {
        ...
        AbstractStoreMovableBlockFragmentIndexVisitorAbstract backwardSearchStartIndexesVisitor = holder
                .getBackwardSearchStartIndexesVisitor();
        AbstractStoreMovableBlockFragmentIndexVisitorAbstract forwardSearchEndIndexesVisitor = holder
                .getForwardSearchEndIndexesVisitor();
    ...
    public String toString() {
        return "Section{flexibleFragments.size=" + flexibleFragments.size() + ", fixedFragment.firstLineNumber="
                + (fixedFragment == null ? "undefined" : fixedFragment.getFirstLineNumber()) + ", rate=" + rate + "}";
    }
