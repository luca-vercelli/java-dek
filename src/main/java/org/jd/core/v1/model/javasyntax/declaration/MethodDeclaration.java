 ...
 * Exceptions, Statements (i.e. method body)
 * 
 */
public class MethodDeclaration implements MemberDeclaration {
	...
	public MethodDeclaration(int flags, String name, Type returnedType, BaseFormalParameter formalParameters,
	...
	public MethodDeclaration(int flags, String name, Type returnedType, BaseFormalParameter formalParameters,
			String descriptor, ElementValue defaultAnnotationValue) {
		this.flags = flags;
		this.name = name;
		this.returnedType = returnedType;
		this.formalParameters = formalParameters;
	...
	public MethodDeclaration(BaseAnnotationReference annotationReferences, int flags, String name,
			BaseTypeParameter typeParameters, Type returnedType, BaseFormalParameter formalParameters,
			BaseType exceptionTypes, String descriptor, BaseStatement statements, ElementValue defaultAnnotationValue) {
