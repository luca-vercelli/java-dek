...
public class TernaryOperatorExpression extends AbstractLineNumberTypeExpression {
	...
	public TernaryOperatorExpression(Type type, Expression condition, Expression trueExpression,
	...
	public TernaryOperatorExpression(int lineNumber, Type type, Expression condition, Expression trueExpression,
			Expression falseExpression) {
