...
public class InnerObjectType extends ObjectType {
    ...
    public InnerObjectType(String internalName, String qualifiedName, String name, int dimension,
    ...
    public InnerObjectType(String internalName, String qualifiedName, String name, BaseTypeArgument typeArguments,
            ObjectType outerType) {
