...
public class StartSingleStatementBlockFragment extends StartFlexibleBlockFragment {
    protected EndSingleStatementBlockFragment end;

    public StartSingleStatementBlockFragment(int minimalLineCount, int lineCount, int maximalLineCount, int weight,
            String label) {
