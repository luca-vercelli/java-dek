...
public class EndSingleStatementBlockFragment extends EndFlexibleBlockFragment {
    protected final StartSingleStatementBlockFragment start;

    public EndSingleStatementBlockFragment(int minimalLineCount, int lineCount, int maximalLineCount, int weight,
            String label, StartSingleStatementBlockFragment start) {
